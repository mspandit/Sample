...
describe UpdatesController do
  ...
  describe "GET public_index" do
    it "assigns all updates as @updates in descending order of creation" do
      update1 = Factory.create(:update, :brief_message => "update1", :details => "details of update1")
      update2 = Factory.create(:update, :brief_message => "update2", :details => "details of update2")
      
      get :public_index
      assigns(:updates).should eq([update2, update1])
    end
  end
